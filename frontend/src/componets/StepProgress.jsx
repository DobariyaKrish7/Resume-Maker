...
const StepProgress = ({progress}) => {
  return (
    ...
    <style>{shimmerStyle}</style>
            ...
            {/* Main Progress Bar */}
            <div
                className="relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-600 animate-flow [animation-delay:-1s] transition-all duration-700 ease-out rounded-full overflow-hidden animate-pulse-glow"
    ...
    <div className='flex justify-between items-center mt-3'>
        ...
        <div className='flex items-center gap-2'>
            {progress === 100 &&
            (
                <div className='w-6 h-6 bg-gradient-to-r from-green-100 to-emerald-500 rounded-full flex items-center justify-center '>
                <Check size={12} className='tex-white' />
