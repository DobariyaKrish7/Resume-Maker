...
import { TitleInput } from './Inputs'
import { useNavigate, useParams } from 'react-router-dom'
import { AlertCircle, ArrowLeft, Check, Download, Loader2, Palette, Save } from 'lucide-react'
import axiosInstance from '../utils/axiosInstance'
import { API_PATHS } from '../utils/apiPath'
import toast from 'react-hot-toast'
import { fixTailwindColors } from '../utils/Color'
    ...
    <DashboardLayout>
        <div className={containerStyles.main}>
            <div className={containerStyles.header}>
                ...
                <div className='flex flex-urge items-center gap-3'>
        ...
        <Modal isOpen={openThemeSelector} onClose={()=> setOpenThemeSelector(false)}
            title='Changetitle'>
                <ThemeSelctor selectedTheme={resumeData?.template.theme}
