...
//   // ctaSection: "py-20 bg-gradient-to-r from-purple-100 to-pink-100",
//   // ctaContainer: "max-w-5xl mx-auto px-6",
//   // ctaCard: "relative bg-white rounded-3xl shadow-lg overflow-hidden",
//   // ctaCardBg: "absolute inset-0 bg-gradient-to-br from-purple-500 to-pink-500 opacity-10",
//   // ctaCardContent: "relative p-10 z-10 text-center",
//   // ctaTitle: "text-3xl sm:text-4xl font-bold text-gray-900",
//   // ctaTitleGradient: "bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent ml-2",
//   // ctaDescription: "mt-4 text-lg text-gray-600",
//   // ctaButton: "mt-6 relative bg-purple-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-purple-700 transition",
//   // ctaButtonOverlay: "absolute inset-0 rounded-lg bg-purple-500 opacity-0 hover:opacity-20 transition",
...
export const landingPageStyles = {
  // Main container
  container: "min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50",

  // Header styles
  header: "fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-blue-100/50",
  headerContainer: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center",
  logoContainer: "flex items-center gap-3",
  logoIcon: "w-10 h-10 bg-gradient-to-br from-blue-600 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200",
  logoIconInner: "w-5 h-5 text-white",
  logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-blue-50 transition-colors",
  mobileMenuIcon: "text-blue-600",

  // Auth buttons
  desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-blue-200",
  desktopAuthButtonText: "relative",
  desktopAuthButtonOverlay: "absolute inset-0 bg-gradient-to-r from-teal-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-bold rounded-2xl",
  ...
  mobileMenuContainer: "max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col gap-4",
  mobileUserInfo: "flex flex-col gap-4 py-2",
  mobileUserWelcome: "text-blue-700 font-medium text-center py-2 text-base sm:text-lg",
  mobileDashboardButton: "w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-blue-200/50 transition-all",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-blue-200/50 transition-all",
  // Main content
  main: "pt-24",
  ...
  heroGrid: "flex flex-wrap justify-between gap-10 lg:gap-12 items-center",
  heroLeft: "space-y-8",
  tagline: "inline-flex items-center gap-2 sm:gap-3 px-4 py-2 bg-gradient-to-r from-blue-100 to-cyan-100 border border-blue-200 text-blue-700 rounded-full font-bold text-xs sm:text-sm",
  heading: "text-4xl sm:text-6xl lg:text-8xl font-black leading-tight",
  headingText: "block text-slate-900",
  headingGradient: "block bg-gradient-to-r from-blue-600 via-teal-600 to-cyan-500 bg-clip-text text-transparent",
  description: "text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed max-w-lg font-medium",
  ctaButtons: "flex flex-col sm:flex-row gap-4",

  // Buttons
  primaryButton: "group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-200",
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-teal-600 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity",
  primaryButtonContent: "relative flex items-center justify-center gap-2 sm:gap-3",
  primaryButtonIcon: "group-hover:translate-x-1 transition-transform",
  secondaryButton: "px-8 sm:px-10 py-3 sm:py-4 border-2 border-blue-200 text-blue-700 font-bold rounded-2xl hover:border-blue-300 hover:bg-blue-50 transition-all",
  ...
  // Hero illustration
  heroIllustration: "relative w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto",
  heroIllustrationBg: "absolute -inset-8 bg-gradient-to-r from-blue-200/50 to-cyan-200/50 rounded-3xl blur-3xl",
  heroIllustrationContainer: "relative",
  ...
  svgRect: "fill-[url(#cardGradient)] stroke-[#e2e8f0] stroke-[2]",
  svgCircle: "fill-[url(#bgGradient)]",
  svgRectPrimary: "fill-[#2563eb]", // blue-600
  svgRectSecondary: "fill-[#0ea5e9]", // sky-500
  svgRectLight: "fill-[#e2e8f0]",
  svgRectSkill: "fill-[#bfdbfe]", // blue-200
  svgAnimatedCircle: "fill-[#06b6d4] opacity-80", // cyan-600
  svgAnimatedRect: "fill-[#10b981] opacity-80", // emerald-500 (kept as it is, still fits ocean theme)
  svgAnimatedPolygon: "fill-[#ef4444] opacity-80", // red-500 (kept as it is, can be a contrast)
  ...
  featuresHeader: "text-center mb-12 sm:mb-20",
  featuresTitle: "text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6",
  featuresTitleGradient: "bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent",
  featuresDescription: "text-base sm:text-lg text-slate-600 max-w-2xl mx-auto font-medium",
  featuresGrid: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8",

  // Feature cards
  featureCard: "group relative",
  featureCardHover: "absolute -inset-2 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity blur-xl rounded-3xl from-blue-200 to-cyan-200",
  featureCardContent: "relative bg-gradient-to-br border border-white/50 p-6 sm:p-8 rounded-3xl hover:shadow-2xl transition-all group-hover:scale-105",
  featureIconContainer: "w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br rounded-2xl flex items-center justify-center mb-4 sm:mb-6 text-white shadow-lg",
  featureIcon: "w-8 h-8 sm:w-10 sm:h-10",
  featureTitle: "text-xl sm:text-2xl font-black text-slate-900 mb-2 sm:mb-4",
  ...
  // Feature gradients
  featureCardViolet: "from-blue-50 to-sky-50",
  featureCardFuchsia: "from-cyan-50 to-teal-50",
  featureCardOrange: "from-indigo-50 to-blue-50",
  featureIconViolet: "from-blue-500 to-sky-600",
  featureIconFuchsia: "from-cyan-500 to-teal-600",
  featureIconOrange: "from-indigo-500 to-blue-600",

  //CTA section
  ctaSection: "py-16 sm:py-24",
  ctaContainer: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center",
  ctaCard: "relative",
  ctaCardBg: "absolute -inset-6 sm:-inset-8 bg-gradient-to-r from-blue-200/50 to-cyan-200/50 rounded-3xl blur-3xl",
  ctaCardContent: "relative bg-gradient-to-br from-white to-blue-50 border border-blue-100 rounded-3xl p-8 sm:p-16",
  ctaTitle: "text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6",
  ctaTitleGradient: "bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent",
  ctaDescription: "text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto font-medium",
  ctaButton: "group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-200",
  ctaButtonOverlay: "absolute inset-0 bg-gradient-to-r from-teal-600 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity",
  ctaButtonText: "relative",
  ...
  footerContainer: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center",
  footerText: "text-sm sm:text-base text-slate-500 font-medium",
  footerHeart: "bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent", // Kept original, can be a splash of contrast
  footerLink: "hover:text-blue-400 underline"
};
...
export const dashboardStyles = {
  ...
  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-200",
  createButtonOverlay: "absolute inset-0 bg-gradient-to-r from-teal-600 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity",
  createButtonContent: "relative flex items-center gap-3",
  ...
  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-sky-50 border-2 border-dashed border-blue-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-blue-500 h-full",
  newResumeIcon: "w-16 h-16 rounded-full bg-gradient-to-r from-blue-600 to-teal-600 flex items-center justify-center mb-4",
  newResumeTitle: "text-xl font-bold text-gray-900 mb-2 text-center",
  newResumeText: "text-gray-600 text-center",
  ...
  // Delete Confirmation
  deleteIconWrapper: "bg-red-100 p-3 rounded-full mb-4", // Kept red for delete action
  deleteTitle: "text-lg font-bold text-gray-900 mb-2",
  deleteText: "text-gray-600 mb-4",
};
...
export const cardStyles = {
  // ProfileInfoCard styles
  profileCard: "flex items-center gap-3 p-2 sm:p-3 bg-white backdrop-blur-xl border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03]",
  profileInitialsContainer: "w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-md",
  profileInitialsText: "text-base sm:text-lg font-black text-white",
  profileName: "text-xs sm:text-sm font-bold text-gray-800",
  logoutButton: "text-blue-600 text-[10px] sm:text-xs font-bold cursor-pointer hover:text-teal-600 transition-colors",

  // ResumeSummaryCard styles
  resumeCard: "group relative h-[360px] sm:h-[380px] lg:h-[400px] flex flex-col bg-white border border-gray-200 rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:border-blue-300",
  cardBackground: "absolute inset-0 bg-gradient-to-br from-blue-100 via-transparent to-cyan-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  previewArea: "p-4 sm:p-6 flex-1 relative overflow-hidden",
  emptyPreview: "w-full h-[180px] sm:h-[200px] lg:h-[220px] flex flex-col items-center justify-center rounded-2xl",
  emptyPreviewIcon: "w-16 h-16 bg-white/90 rounded-2xl flex items-center justify-center mb-4 shadow-md",
  emptyPreviewText: "text-gray-800 text-sm font-bold",
  emptyPreviewSubtext: "text-gray-500 text-xs mt-1",
  infoArea: "bg-gray-50 border-t border-gray-200 p-4 sm:p-6",
  title: "text-sm sm:text-base font-bold text-gray-800 truncate mb-2 group-hover:text-blue-600 transition-colors",
  dateInfo: "flex items-center gap-2 text-xs text-gray-500",

  // Action buttons
  actionOverlay: "absolute inset-4 sm:inset-6 bg-gradient-to-t from-white/80 via-white/20 to-transparent flex items-end justify-center p-6 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-2xl",
  actionButtonsContainer: "flex gap-3",
  editButton: "group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-blue-600 to-teal-600 rounded-2xl shadow-md hover:scale-110 transition-all duration-300",
  deleteButton: "group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-red-500 to-red-600 rounded-2xl shadow-md hover:scale-110 transition-all duration-300", // Kept red for delete
  buttonIcon: "text-white group-hover/btn:scale-110 transition-transform",
  ...
  // Completion color classes
  completionHigh: "from-emerald-500 to-green-600", // Kept for high completion
  completionMedium: "from-yellow-500 to-orange-500", // Kept for medium completion
  completionLow: "from-red-500 to-pink-600", // Kept for low completion

  // TemplateCard styles
  templateCard: "relative rounded-lg overflow-hidden shadow-md transition-all duration-300 cursor-pointer border border-gray-200",
  templateCardSelected: "ring-2 ring-blue-500 scale-[1.02]",
  templateCardDefault: "hover:shadow-lg hover:border-gray-300",
  templateDesign: "relative h-full w-full aspect-[4/5]",
  templateOverlay: "absolute inset-0 bg-white/10 backdrop-blur-sm",
  selectionIndicator: "absolute top-4 right-4 z-20",
  selectionCircle: "w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center shadow-md",
  selectionIcon: "text-white",
  templateHoverEffect: "absolute inset-0 bg-black/5 opacity-0 hover:opacity-100 transition-opacity duration-300",
  templateName: "text-sm font-medium text-gray-800",
  emptyTemplate: "relative h-full w-full rounded-lg overflow-hidden",
...
export const authStyles = {
  ...
  form: "space-y-6",
  errorMessage: "text-red-500 text-sm font-medium bg-red-50 border border-red-200 px-4 py-3 rounded-xl",
  submitButton: "w-full py-4 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-blue-200 transition-all text-lg",
  switchText: "text-center text-sm text-slate-600 font-medium",
  switchButton: "font-black text-blue-600 hover:text-teal-600 transition-colors",
...
export const shimmerStyle = `
  ...
  @keyframes pulse-glow {
    0%, 100% { box-shadow: 0 0 20px rgba(37, 99, 235, 0.3); } /* blue-600 shadow */
    50% { box-shadow: 0 0 40px rgba(37, 99, 235, 0.6); } /* blue-600 shadow */
  }
...
export const additionalInfoStyles = {
  ...
  heading: "text-2xl font-black text-slate-900 mb-8",
  sectionHeading: "text-lg font-bold text-slate-800 mb-6 flex items-center gap-2",
  dotViolet: "w-2 h-2 bg-gradient-to-r from-blue-500 to-teal-500 rounded-full",
  dotOrange: "w-2 h-2 bg-gradient-to-r from-cyan-500 to-sky-500 rounded-full",
  languageItem: "relative bg-white border border-blue-100 p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all",
  interestItem: "relative",
  addButtonLanguage: "bg-gradient-to-r from-blue-500 to-teal-500",
  addButtonInterest: "bg-gradient-to-r from-cyan-500 to-sky-500",
};
...
export const certificationInfoStyles = {
  ...
  heading: "text-2xl font-black text-slate-900 mb-8",
  item: "relative bg-white border border-indigo-100 p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all",
  addButton: "bg-gradient-to-r from-indigo-500 to-blue-500",
};
...
export const workExperienceStyles = {
  ...
  addButton: "bg-gradient-to-r from-blue-500 to-teal-500",
};
...
export const buttonStyles = {
  ...
  delete: "flex items-center gap-2 px-3 sm:px-4 py-2 bg-red-100 text-red-700 font-bold rounded-xl hover:bg-red-200 transition-all", // Kept red for delete
  download: "flex items-center gap-2 px-3 sm:px-4 py-2 bg-emerald-100 text-emerald-700 font-bold rounded-xl hover:bg-emerald-200 transition-all", // Kept for download
  back: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gray-100 text-gray-700 font-bold rounded-xl hover:bg-gray-200 transition-all text-sm",
  save: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-blue-100 text-blue-700 font-bold rounded-xl hover:bg-blue-200 transition-all text-sm",
  next: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-500 to-teal-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg text-sm",
  modalAction: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-500 to-teal-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg text-sm"
};

export const statusStyles = {
  completionBadge: "inline-flex items-center gap-2 bg-gray-100 px-3 py-1 rounded-full text-sm font-medium text-gray-700",
  modalBadge: "inline-flex items-center gap-2 bg-blue-100 px-3 py-1 rounded-full text-sm font-medium text-blue-700",
  error: "flex items-center gap-3 text-sm font-medium text-amber-700 bg-amber-50 border border-amber-200 px-4 py-3 rounded-xl mb-4" // Kept amber for error
};

export const iconStyles = {
  pulseDot: "w-2 h-2 rounded-full bg-emerald-500 animate-pulse" // Kept green/emerald for pulse dot
};
...
export const photoSelectorStyles = {
  container: "flex justify-center mb-8",
  hiddenInput: "hidden",
  placeholder: hovered => `relative w-32 h-32 sm:w-36 h-36 flex items-center justify-center bg-gray-50 border-2 border-dashed border-gray-300 rounded-full cursor-pointer transition-all duration-300 ${hovered ? 'hover:border-blue-500 hover:bg-blue-50' : ''}`,
  cameraButton: "absolute -bottom-2 -right-2 w-12 h-12 flex items-center justify-center bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-white rounded-full transition-all shadow-lg hover:scale-110",
  previewWrapper: "relative group",
  previewImageContainer: hovered => `w-32 h-32 sm:w-36 h-36 rounded-full overflow-hidden border-4 border-gray-200 shadow-lg transition-all duration-300 ${hovered ? 'group-hover:border-blue-400' : ''}`,
  previewImage: "w-full h-full object-cover cursor-pointer group-hover:scale-110 transition-transform duration-300",
  overlay: "absolute inset-0 bg-black/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center",
  actionButton: (bg, hoverBg, textColor) => `w-10 h-10 flex items-center justify-center bg-${bg} text-${textColor} rounded-full hover:bg-${hoverBg} transition-all`,
};
...
export const titleInputStyles = {
  ...
  confirmButton: "p-2 rounded-xl bg-blue-500 hover:bg-blue-600 text-white transition-all",
};
...
export const modalStyles = {
  ...
  title: "text-xl font-black text-slate-900",
  actionButton: "flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-teal-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg mr-12",
  closeButton: "absolute top-4 right-4 w-10 h-10 flex items-center justify-center bg-white/80 hover:bg-red-50 text-slate-400 hover:text-red-500 rounded-xl transition-all shadow-lg hover:scale-110 z-10", // Kept red for close
  body: "flex-1 overflow-y-auto"
};
...
export const infoStyles = {
  ...
  actionWrapper: "flex items-center gap-3",
  actionIconWrapper: "w-6 h-6 flex items-center justify-center rounded-full",
  actionLink: "text-sm font-medium underline cursor-pointer break-all text-gray-600 hover:text-blue-600 transition-colors",
