...
export const landingPageStyles = {
  container: 'min-h-screen bg-gray-50 text-gray-800',
  header: 'bg-white shadow-md',
  headerContainer: 'max-w-7xl mx-auto px-4 flex justify-between items-center py-4',
  headerlogoContainer: 'flex items-center gap-2',
  logoIcon: 'text-indigo-600',
  logoIconInner: 'w-6 h-6',
  logoText: 'text-xl font-bold tracking-wide',

  hero: 'text-center py-20 bg-gradient-to-b from-gray-50 to-white',
  heroTitle: 'text-4xl font-extrabold text-gray-900 mb-4',
  heroSubtitle: 'text-gray-600 text-lg mb-6',
  heroCTAButton:
    'bg-indigo-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-indigo-700 transition duration-200',
};

export const navbarStyles = {
  container: 'w-full bg-white shadow fixed top-0 left-0 z-50',
  inner: 'max-w-7xl mx-auto flex justify-between items-center p-4',
  brand: 'text-xl font-bold text-indigo-600',
  link: 'text-gray-700 hover:text-indigo-600 px-3 py-2 text-sm font-medium',
  button: 'bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition',
};

export const builderStyles = {
  container: 'max-w-7xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-8',
  formSection: 'bg-white p-6 shadow rounded-md',
  ...
  textarea:
    'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm resize-none focus:outline-none focus:ring-indigo-500 focus:border-indigo-500',
  addButton:
    'mt-2 inline-block bg-green-500 text-white px-4 py-1 rounded hover:bg-green-600',
};

export const previewStyles = {
  wrapper: 'bg-white p-6 shadow rounded-md border',
  resumeBox: 'p-6 border border-gray-200 rounded bg-white',
  name: 'text-2xl font-bold text-gray-900',
  sectionHeading: 'text-lg font-semibold text-indigo-600 mt-6 mb-2',
  item: 'mb-2',
...
export const footerStyles = {
  container: 'bg-gray-100 py-6 text-center text-sm text-gray-500',
};
