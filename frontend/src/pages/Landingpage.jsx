        ...
        <div className={landingPageStyles.headerContainer}>
          ...
          <div className='hidden md:flex items-center'>
            {user ? (
              ...
              <button className={landingPageStyles.desktopAuthButton} onClick={handleCTA}>
            ...
            <div className="flex flex-wrap gap-6 sm:gap-10 mt-10">
              {[
                ...
                <div key={index} className="text-center">
                  <h3 className={`text-3xl sm:text-4xl font-black bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent`}>
                    {stat.value}
                  </h3>
        ...
        <section className={landingPageStyles.featuresSection}>
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              ...
              <p>Our platform is designed to help you create a professional resume that stands out from the crowd.</p>
            </div>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                <h2 className={landingPageStyles.ctaTitle}>
                  Ready to create your <span className={landingPageStyles.ctaTitleGradient}>dream resume?</span>
                </h2>
